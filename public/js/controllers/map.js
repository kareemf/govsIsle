...
controllers.controller('MarkerListController', ['$scope', '$state','$stateParams', '$http', 'Events', 'Amenities','Shared', 'Tours', function($scope, $state, $stateParams, $http, Events, Amenities, Shared, Tours){
